...
public class GetUserRequestHandler(UserManager<ApplicationUser> userManager) : IRequestHandler<GetUserRequest, ApplicationUserDto?>
{
    private readonly UserManager<ApplicationUser> userManager = userManager;

    public async Task<ApplicationUserDto?> Handle(GetUserRequest request, CancellationToken cancellationToken)
    {
